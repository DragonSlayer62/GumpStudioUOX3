...
namespace GumpStudio.Elements
{
	...
	public class TextEntryElement : ResizeableElement, ICSharpExportable
	{
		...
		public override string Type => "AddTextEntry";
		...
		{
			if (MaxLength > 0)
				return $"uox3gump.AddTextEntry({X}, {Y}, {Width}, {Height}, {Hue}, 0, \"{InitialText?.Replace("\"", "\\\"")}\", {MaxLength});";
				
			return $"uox3gump.AddTextEntry({X}, {Y}, {Width}, {Height}, {Hue}, 0, \"{InitialText?.Replace("\"", "\\\"")}\");";
		}
	}
}
