...
namespace GumpStudio.Elements
{
	...
	public class HTMLElement : ResizeableElement, ICSharpExportable
	{
		...
		public override string Type => "AddXMFHTMLTok";
		...
		public override void Render(Graphics Target)
		{
			...
			if (mScrollbar)
			{
				...
				var region = new Region(new Rectangle(X + Width - imgBack.Width, Y + imgUp.Height + imgLoc.Height, imgBack.Width, Height - imgDown.Height - imgUp.Height - imgLoc.Height));
				Target.Clip = region;
			...
			var layoutRectangle = new RectangleF(rectangle2.X, rectangle2.Y, rectangle2.Width, rectangle2.Height);
